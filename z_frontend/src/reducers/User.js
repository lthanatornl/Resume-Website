...
export const updateReducer = createReducer(
  {},
  {
    ...
    ADD_GRADUATION_REQUEST: (state) => {
      state.loading = true;
    },
    ADD_GRADUATION_SUCCESS: (state, action) => {
      state.loading = false;
      state.message = action.payload;
    },
    ADD_GRADUATION_FAILURE: (state, action) => {
      state.loading = false;
      state.error = action.payload;
    },

    DELETE_GRADUATION_REQUEST: (state) => {
      state.loading = true;
    },
    DELETE_GRADUATION_SUCCESS: (state, action) => {
      state.loading = false;
      state.message = action.payload;
    },
    DELETE_GRADUATION_FAILURE: (state, action) => {
      state.loading = false;
      state.error = action.payload;
    },
